...
describe('ProgressBarWithLabel', () => {
  it('renders progress bar correctly', () => {
    const { getByTestId } = render(
      <ProgressBarWithLabel progress={0.5} />
    );
  ...
  it('displays label when provided', () => {
    const { getByText } = render(
      <ProgressBarWithLabel progress={0.7} label="70% Complete" />
    );
  ...
  it('uses custom width when provided', () => {
    const { getByTestId } = render(
      <ProgressBarWithLabel progress={0.5} width={300} />
    );
    const progressBar = getByTestId('progress-bar');
  ...
  it('applies correct progress value', () => {
    const { getByTestId } = render(
      <ProgressBarWithLabel progress={0.75} />
    );
    const progressBar = getByTestId('progress-bar');
  ...
  it('handles progress value of 1', () => {
    const { getByTestId } = render(
      <ProgressBarWithLabel progress={1} />
    );
    const progressBar = getByTestId('progress-bar');
  ...
  it('applies correct styling to label', () => {
    const { getByText } = render(
      <ProgressBarWithLabel progress={0.5} label="Test Label" />
    );
  ...
  it('maintains proper container structure', () => {
    const { getByTestId, getByText } = render(
      <ProgressBarWithLabel progress={0.6} label="Container Test" />
    );
  ...
  it('handles edge case values gracefully', () => {
    const { getByTestId } = render(
      <ProgressBarWithLabel progress={-0.1} />
    );
    const progressBar = getByTestId('progress-bar');
  ...
  it('handles values above 1 gracefully', () => {
    const { getByTestId } = render(
      <ProgressBarWithLabel progress={1.5} />
    );
    const progressBar = getByTestId('progress-bar');
  ...
  it('applies correct unfilled color', () => {
    const { getByTestId } = render(
      <ProgressBarWithLabel progress={0.3} />
    );
    const progressBar = getByTestId('progress-bar');
