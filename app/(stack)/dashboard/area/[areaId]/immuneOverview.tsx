    ...
    <>
      ...
      <Card title={t('immuneOverview.whyTheseMetricsMatter.title')}>
        ...
        <View style={globalStyles.infoSection}>
          ...
          <ThemedText type="default">{t('immuneOverview.whyTheseMetricsMatter.stress.description')}</ThemedText>
        </View>

        <View style={globalStyles.infoSection}>
          <ThemedText type="title3">❤️ {t('immuneOverview.whyTheseMetricsMatter.hrv.title')}</ThemedText>
          <ThemedText type="default">{t('immuneOverview.whyTheseMetricsMatter.hrv.description')}</ThemedText>
        </View>

        <View style={globalStyles.infoSection}>
          <ThemedText type="title3">🫀 {t('immuneOverview.whyTheseMetricsMatter.restingHeartRate.title')}</ThemedText>
          <ThemedText type="default">{t('immuneOverview.whyTheseMetricsMatter.restingHeartRate.description')}</ThemedText>
        </View>

        <View style={globalStyles.infoSection}>
          <ThemedText type="title3">🦠 {t('immuneOverview.whyTheseMetricsMatter.microbiomeButyrate.title')}</ThemedText>
          <ThemedText type="default">{t('immuneOverview.whyTheseMetricsMatter.microbiomeButyrate.description')}</ThemedText>
        </View>
      </Card>
