  ...
  return (
    <Portal>
      ...
      {isSleepBatchSheetVisible && (
        <SleepBatchBottomSheet
          sheetIndex={sheetIndex}
          bottomSheetRef={registerSleepBatchBottomSheetRef}
          colors={colors}
          styles={styles}
          setMetricEntries={setMetricEntries}
          metrics={metrics}
          handleCloseSleepBatchSheet={handleCloseSleepBatchSheet}
        />
      )}
    </Portal>
  );
