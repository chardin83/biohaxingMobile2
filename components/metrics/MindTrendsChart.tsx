  ...
  return (
    <>
      <Card title={t('mindTrendsChart.title')}>
        ...
        <View style={styles.metricRow}>
          <StepsMetric showDivider={true} onPress={() => toggleMetric('steps')} isSelected={selectedMetric === 'steps'} />
          <TodaysIntensityMinutesMetric
            showDivider={false}
        ...
        <ThemedText type="explainer" style={[globalStyles.explainer, { borderColor: colors.borderLight }]}>
          {selectedMetric ? t(`mindTrendsChart.explainers.${selectedMetric}`) : t('mindTrendsChart.explainer')}
        </ThemedText>
      </Card>
