...
export const isPositiveVerdict = (v?: VerdictValue) => (v ? POSITIVE_VERDICTS.includes(v) : false);

export const isNegativeVerdict = (v?: VerdictValue) => (v ? NEGATIVE_VERDICTS.includes(v) : false);
