  ...
  return mockReact.forwardRef(function MockCalendarComponent({ onDayPress }: any, ref: any) {
    ...
    return (
      <View testID="calendar-component">
        ...
        <TouchableOpacity 
          testID="day-2024-01-15" 
          onPress={() => onDayPress('2024-01-15')}
        >
          <Text>Jan 15</Text>
        </TouchableOpacity>
        <TouchableOpacity 
          testID="day-2024-01-16" 
          onPress={() => onDayPress('2024-01-16')}
        >
          <Text>Jan 16</Text>
        </TouchableOpacity>
      </View>
  ...
  return function MockDayEdit({ selectedDate, selectedSupplement, onSupplementSelect }: any) {
    ...
    return (
      <View testID="day-edit">
        ...
        <TouchableOpacity 
          testID="supplement-button"
          onPress={() => onSupplementSelect({ name: 'Vitamin D3' })}
        >
