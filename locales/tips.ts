...
const rawTips: Tip[] = [
  ...
  },
  {
    ...
    nutritionFoods: [
      {
        key: 'pomegranate',
        nutrientTags: ['ellagitannins', 'polyphenols_total'],
        microbiomeSupport: ['Gordonibacter'],
  ...
  },
  {
    ...
    targetIconName: 'mineral',
    mineralTargets: [
      { tag: 'sodium', amount: 1500, unit: 'mg', sourceBackedWeight: 1, inferredWeight: 0.6 },
      { tag: 'potassium', amount: 3500, unit: 'mg', sourceBackedWeight: 1, inferredWeight: 0.6 },
      { tag: 'magnesium', amount: 320, unit: 'mg', sourceBackedWeight: 1, inferredWeight: 0.7 },
  ...
  {
    id: 'leucine_rich_food',
    level: 3,
    xp: 400,
    areas: [
      { id: 'strength', descriptionKey: 'leucine_rich_food.areas.strength' },
      { id: 'cardioFitness', descriptionKey: 'leucine_rich_food.areas.cardioFitness' },
    ],
    title: 'leucine_rich_food.title',
    descriptionKey: 'leucine_rich_food.description',
    trainingRelation: 'postWorkout',
  ...
  },
  {
    ...
    timeRule: 'anytime',
    planCategory: ['nutrition'],
    nutritionFoods: [{ key: 'greekYogurt' }, { key: 'kefir' }, { key: 'sauerkraut' }, { key: 'kimchi' }],
    bodyParts: ['digestiveSystem'],
  ...
  },
  {
    ...
    nutritionFoods: [
      ...
      {
        key: 'blackCurrants',
        nutrientTags: ['polyphenols_total', 'anthocyanins', 'flavonoids_total'],
        microbiomeSupport: ['Akkermansia', 'Roseburia', 'Ruminococcus'],
        sourceRefs: ['Phenol-Explorer', 'USDA FoodData Central'],
        defaultConfidence: 'high',
      },
